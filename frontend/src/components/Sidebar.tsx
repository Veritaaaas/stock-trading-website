...
import { EyeOpenIcon, EyeClosedIcon, DashboardIcon, BookmarkIcon, HomeIcon, ReaderIcon, ClockIcon } from '@radix-ui/react-icons';
...
export default function Sidebar() {
    ...
    return (
        <div className="bg-white w-full min-h-screen p-8 flex flex-col gap-8 font-sans h-full">
